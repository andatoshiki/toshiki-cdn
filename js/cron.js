! function a(u, i, s) {
        ...
        t.exports = function(e) {
            ...
            return n.model = function(e) {
                ...
                w.forEach(function(e) {
                    ...
                    o.push(t);
                    var n = e.state || {};
                    t ? (a[t] = a[t] || {}, N(t, n, a), a[t] = A(a[t], r[t])) : E(a, n)
            ...
            function t(e) {
                e.onStateChange && p.push(e.onStateChange), e.onError && i.push(S(e.onError)), e.onAction && v.push(e.onAction), e.wrapSubscriptions && o.push(e.wrapSubscriptions), e.wrapInitialState && s.push(e.wrapInitialState), e.wrapReducers && a.push(e.wrapReducers), e.wrapEffects && c.push(e.wrapEffects)
            }
            ...
            function n(n) {
                ...
                }), m || !1 === n.state || (x = T(x, s)), n.noSubscriptions || (f = !0), n.noReducers || (l = !0), n.noEffects || (d = !0), n.noState || (m = !0), i.length || i.push(S(r)), h;
        ...
        t.exports = function(s) {
            ...
            function m(n, e) {
                e || "string" == typeof n || (e = n, n = null), e = e || {}, a.model(function(e) {
                    ...
                    }, "handleHash", r) : (!1 !== e.history && o(h, "handleHistory", r), !1 !== e.href && o(y, "handleHref", r)), {
                        namespace: "location",
                        subscriptions: r,
                        reducers: {
    ...
    29: [function(e, t, n) {
        "use strict";
        var j, k = "http://www.w3.org/1999/xhtml",
        ...
        var P, a = (P = function(e, t) {
            ...
            if (e || (e = {}), "string" == typeof v)
                ...
                } else n = v, !j && _.createRange && (j = _.createRange()).selectNode(_.body), j && j.createContextualFragment ? r = j.createContextualFragment(n) : (r = _.createElement("body")).innerHTML = n, v = r.childNodes[0];
                    ...
                    if ("TEXTAREA" !== e.nodeName) {
                        ...
                        e: for (; c;) {
                            for (i = c.nextSibling, a = y(c); l;) {
                                ...
                                var d = l.nodeType,
                                    m = void 0;
                                if (d === c.nodeType && (1 === d ? (a ? a !== r && ((s = E[a]) ? l.nextSibling === s ? m = !1 : (e.insertBefore(s, l), u = l.nextSibling, r ? A(r) : C(l, e, !0), l = s) : m = !1) : r && (m = !1), (m = !1 !== m && D(l, c)) && S(l, c)) : 3 !== d && 8 != d || (m = !0, l.nodeValue !== c.nodeValue && (l.nodeValue = c.nodeValue))), m) {
                                    c = i, l = u;
                                    continue e
                                }
                                r ? A(r) : C(l, e, !0), l = u
                            ...
                            if (a && (s = E[a]) && D(s, c)) e.appendChild(s), S(s, c);
                                ...
                                var f = g(c);
                                !1 !== f && (f && (c = f), c.actualize && (c = c.actualize(e.ownerDocument || _)), e.appendChild(c), N(c))
                            }
                            c = i, l = u
                        }
                        for (; l;) u = l.nextSibling, (r = y(l)) ? A(r) : C(l, e, !0), l = u
                    }
                    var h = O[e.nodeName];
                    h && h(e, t)
                }
            ...
            var c, l, d = p,
                ...
                f = v.nodeType;
            if (!s)
                if (1 === m) 1 === f ? D(p, v) || (i(p), d = function(e, t) {
                    for (var n = e.firstChild; n;) {
                        var r = n.nextSibling;
                        t.appendChild(n), n = r
                    }
                    return t
                }(p, (c = v.nodeName, (l = v.namespaceURI) && l !== k ? _.createElementNS(l, c) : _.createElement(c)))) : d = v;
                else if (3 === m || 8 === m) {
            ...
            return !s && d !== p && p.parentNode && (d.actualize && (d = d.actualize(p.ownerDocument || _)), p.parentNode.replaceChild(d, p)), d
        });
        t.exports = a
    }, {}],
    30: [function(e, t, n) {
